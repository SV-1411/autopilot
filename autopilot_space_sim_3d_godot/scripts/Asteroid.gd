...
# Visual representation of a moving obstacle. Motion is simulated in SimWorld;
# this node holds the asteroid's design parameters (position, velocity, size,
# mass) for editing, and renders it.
